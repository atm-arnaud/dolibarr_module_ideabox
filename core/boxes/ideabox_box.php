 ...
 */
class ideaboxbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "ideabox@ideabox";
    public $boxlabel;
    public $depends = array("ideabox");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/ideabox/class/ideabox.class.php";
